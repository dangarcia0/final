...
<body>
    ...
    <div class="card">
      <div class="card-body bg-purple text-white">
        <div class="row">
          ...
          <div class="col-2">
            <a href="textutasyefectos.php" class="text-black">Texturas y Efectos</a>
          </div>
          <div class="col-2">
  ...
  <h2 class="text-center mt-3" style="font-family: 'Arial', sans-serif; font-weight: bold;">Esmaltes</h2>
